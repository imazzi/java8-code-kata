...
//        Comparator<Integer> descOrder = Comparator.reverseOrder();
        Comparator<Integer> descOrder = (age1, age2) -> age2.compareTo(age1);
    ...
    public void top3RichCustomer() {
         ...
         */
        Stream<String> top3RichCustomerStream = customerList.stream().sorted((o1, o2) -> o2.getBudget().compareTo(o1.getBudget())).map(Customer::getName).limit(3);
